...
public class ProctorController implements CommonController {
    ...
    private void showHomeView() {
        loadView("ProctorHomeView.fxml"); // Corrected View
        setActiveNav(homeButton);
    }

    @FXML
    private void showCategoriesView() {
        loadView("ProctorCategoriesView.fxml");
        setActiveNav(categoriesButton);
    }

    @FXML
    private void showReportsView() {
        loadView("ProctorReportsView.fxml");
