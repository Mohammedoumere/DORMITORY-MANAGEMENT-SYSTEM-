...
public class StudentHomeController implements CommonController {
    ...
    @FXML private Button myDetailsButton;
    ...
    private void showHomeView() {
        loadView("StudentWelcomeView.fxml");
        setActiveNav(homeButton);
    }

    @FXML
    private void showMyDetailsView() {
        loadView("StudentDetailsView.fxml");
        setActiveNav(myDetailsButton);
    }

    @FXML
    private void showReportsView() {
        loadView("StudentReportView.fxml");
